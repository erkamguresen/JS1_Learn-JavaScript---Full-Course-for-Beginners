...
![progress](https://img.shields.io/badge/Progress-03.26.42%20|%2003.26.42-blue)
...
- Default Parameters Page: examples from Evan (Hack Your Future) coach about assigning functions to 'const' (for the scope of this tutorial it is useless and adding unnecessary complexity to the code).
